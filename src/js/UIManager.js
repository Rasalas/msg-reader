        ...
        const emailContent = `
            <div class="message-header">
                ...
                <div class="message-actions pr-4">
                    <button onclick="window.app.togglePin(${this.messageHandler.getMessages().indexOf(msgInfo)})" class="action-button rounded-full ${this.messageHandler.isPinned(msgInfo) ? 'pinned' : ''}" title="Nachricht anpinnen">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M17.593 3.322c1.1.128 1.907 1.077 1.907 2.185V21L12 17.25 4.5 21V5.507c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0 1 11.186 0Z" />
                        </svg>
                    </button>
                    <button onclick="window.app.deleteMessage(${this.messageHandler.getMessages().indexOf(msgInfo)})" class="action-button rounded-full" title="Nachricht löschen">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <div class="bg-white p-6 rounded-3xl border border-gray-200 border-solid">
                ...
                <div class="prose max-w-none">
                    ${msgInfo.bodyContentHTML || msgInfo.bodyContent || '<p>(No content)</p>'}
                </div>
                ${this.renderAttachments(msgInfo)}
            </div>
        `;
        
        this.messageViewer.innerHTML = emailContent;
    }
